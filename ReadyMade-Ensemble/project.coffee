# nmp install to view: https://www.npmjs.org/package/zooniverse-readymade
# zooniverse-readymade serve to open browser
module.exports =
  id: 'project_id'
  background: 'ensemble.jpg'

  producer: 'Zooniverse Test'
  title: 'Ensemble'
  summary: 'Old Playbills'
